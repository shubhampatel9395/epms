...
--
-- Table structure for table `enupaymentstakeholder`
--

DROP TABLE IF EXISTS `enupaymentstakeholder`;
...
--
-- Dumping data for table `enupaymentstakeholder`
--

LOCK TABLES `enupaymentstakeholder` WRITE;
/*!40000 ALTER TABLE `enupaymentstakeholder` DISABLE KEYS */;
/*!40000 ALTER TABLE `enupaymentstakeholder` ENABLE KEYS */;
UNLOCK TABLES;
