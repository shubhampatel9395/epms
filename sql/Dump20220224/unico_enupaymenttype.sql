...
--
-- Table structure for table `enupaymenttype`
--

DROP TABLE IF EXISTS `enupaymenttype`;
...
--
-- Dumping data for table `enupaymenttype`
--

LOCK TABLES `enupaymenttype` WRITE;
/*!40000 ALTER TABLE `enupaymenttype` DISABLE KEYS */;
/*!40000 ALTER TABLE `enupaymenttype` ENABLE KEYS */;
UNLOCK TABLES;
